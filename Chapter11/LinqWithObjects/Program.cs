...
// Question: Which names end with an M?
// (written using a LINQ query comprehension syntax)
var query2 = from name in names where name.EndsWith("m") select name;

// Answer returned as an array of strings containing Pam and Jim
string[] resul1 = query1.ToArray();

// Answer returned as a list of strings conatining Pam and Jim
...
foreach (string name in query1)
{
    ...
    //on the second iteraction Jimmy does not end with an M
}
...
Output(cohort2.Zip(cohort2,(c1, c2) => $"{c1} matched with {c2}"), "cohort1.Zip(cohort2)");